...
func (s *Server) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	default:
		...
		switch elem[0] {
		case '/': // Prefix: "/things"
			if l := len("/things"); len(elem) >= l && elem[0:l] == "/things" {
				elem = elem[l:]
			} else {
				break
			}
			...
			if len(elem) == 0 {
				switch r.Method {
				case "GET":
					s.handleListThingsRequest([0]string{}, elemIsEscaped, w, r)
				case "POST":
			...
			case '/': // Prefix: "/"
				...
				if len(elem) == 0 {
					...
					case "GET":
						s.handleGetThingRequest([1]string{
							args[0],
						}, elemIsEscaped, w, r)
					case "PUT":
